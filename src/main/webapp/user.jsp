...
<BODY>
		...
		<table id="dg" title="用户管理" class="easyui-datagrid" style="height:550px;">
        <thead>
            <tr>
    ...
    <div id="toolbar">
       <shiro:hasPermission name="user:add"> <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="add()">添加</a></shiro:hasPermission>
       <shiro:hasPermission name="user:edit"> <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="edit()">修改</a></shiro:hasPermission>
       <shiro:hasPermission name="user:delete"> <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="deletePark()">删除</a></shiro:hasPermission>
    </div>
      <div id="dlg" class="easyui-dialog" style="width:400px"
        ...
        <form id="fm" method="post" novalidate style="margin:0;padding:20px 50px">
            ...
            <div style="margin-bottom:10px">
             ...
             <div style="margin-bottom:10px">
                <input name="usrpwd" type="text" class="easyui-textbox"  label="用户密码" style="width:100%">
            </div>
