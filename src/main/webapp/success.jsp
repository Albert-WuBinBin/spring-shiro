...
<body class="easyui-layout">
	<div data-options="region:'north',border:false"
		...
		<span id="welcome">欢迎您：<a href="#" class="easyui-menubutton"
			data-options="menu:'#mm1'"><h1>
					<shiro:principal />
				</h1></a></span>
	...
	<div data-options="region:'west',split:true,title:'菜单'"
		...
		<div id="nav" class="easyui-accordion" fit="false" border="false">
			...
			<c:forEach items="${sessionScope.url}" var="u">
				<h1>
					<a href="${pageContext.request.contextPath}/${u.url}"
						target="MyIframe">${u.re_name}</a>
				</h1>
			</c:forEach>
	...
	<div data-options="region:'center'">
		<iframe name="MyIframe" id="MyIfrmae" scrolling="auto" frameborder="0"
